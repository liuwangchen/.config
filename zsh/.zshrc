...
alias cll='code ~/work/ll'
alias cjj='code ~/work/jj'
alias ckk='code ~/onedrive/Documents/kk'
alias cdd='code ~/work/dd'
...
alias lt='tail -f ~/onedrive/Documents/kk/log/ling.log'
alias o='open $(f)'
alias gm="curl -s --request POST --url 'http://localhost/?rpc=20610&name=guild.mem.info' --header 'content-type: application/json' --header 'user-agent: vscode-restclient'"
